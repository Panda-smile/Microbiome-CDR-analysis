...
meta_filt <- filter(all_data_list[[2]],filename %in% spc_reor_filt$filename) #,wavenum == "854", group_strain %in%c("DJ_1","DJ_2")
...
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_HTD_all_S1toS4.svg", sep=""),plot=umap_plot,
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S1.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S2.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S3.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S4.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S1andS4.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S1andS3.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S1andS2.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S3andS4.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S2andS3.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)
...
umap_plot <- ggplot(data.umap_FQ_1, aes(UMAP_1, UMAP_2,color = CD_ratio)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","plotpoint_S2andS4.svg", sep=""),plot=umap_plot,
       limitsize=F,width = 7,height = 6)

data.umap_JN <- data.umap %>% filter(group_strain %in% c("DJ_1","DJ_2"))
...
umap_plot <- ggplot(data.umap_JN, aes(UMAP_1, UMAP_2,color = group_strain)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","DJ_1.svg", sep=""),plot=umap_plot,
...
umap_plot <- ggplot(data.umap_JN, aes(UMAP_1, UMAP_2,color = group_strain)) + 
  ...
  theme(panel.grid = element_blank(), 
        ...
        axis.title = element_text(size = 15))
umap_plot
ggsave(filename=paste(outpath,"/","DJ_2.svg", sep=""),plot=umap_plot,
